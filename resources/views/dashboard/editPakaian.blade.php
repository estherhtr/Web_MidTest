...
@endif
        <form action="/dashboard/edit/{{$clothes->id}}" method="post">
            @csrf
            @method('PUT')
        <div class="form-floating mb-3">
  <input type="text" class="form-control" id="kodebrg"  name='kode_barang' value="{{ $clothes->kode_barang ?? '' }}">
  <label for="kodebrg" >Kode Barang</label>
</div>
        <div class="form-floating mb-3">
  <input type="text" class="form-control" id="namabrg"  name='nama_barang' value="{{$clothes->nama_barang ?? ''}}">
  <label for="namabrg" >Nama Barang</label>
</div>
        <div class="form-floating mb-3">
  <input type="text" class="form-control" id="ukuran"  name='ukuran' value="{{ $clothes->ukuran ?? '' }}">
  <label for="ukuran" >Ukuran</label>
</div>
<div class="form-floating">
  <textarea class="form-control" id="floatingTextarea" name="deskripsi">{{ $clothes->deskripsi ?? '' }}</textarea>
